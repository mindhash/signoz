...
type APIHandler struct {
	...
	// todo(amol): need to fetch this from config. determines if this
	// installation supports multiple orgs. Multi org is mainly the case for
	// cloud only.
	IsMultiOrgAvailable bool
